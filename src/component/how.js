...
const How = () => {
  return (
    ...
    <div className="container bg-white mx-auto px-4 py-12 border-2 border-gray-400 rounded-lg text-center">
        <h1 className="text-4xl font-bold  mb-8">How to Use Typo Terminators</h1>
        <h2 className="text-2xl font-bold  mb-4">Frequently Asked Questions</h2>
        <h3 className="text-lg font-bold  mb-2">1. How do I generate a cover letter using Typo Terminators?</h3>
        <p className=" mb-4">
        ...
        <h3 className="text-lg font-bold  mb-2">2. How do I fix typos and spelling errors in my essay using Typo Terminators?</h3>
        <p className=" mb-4">
        ...
        <h3 className="text-lg font-bold  mb-2">3. How do I know this is safe to use?</h3>
        <p className=" mb-4">
        ...
        <h3 className="text-lg font-bold  mb-2">4. What kind of questions can it answer?</h3>
        <p className=" mb-4">
        ...
        <h3 className="text-lg font-bold  mb-2">5. Is this cheating?</h3>
        <p className=" mb-4">
